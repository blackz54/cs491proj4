...
def compress_images(DATA,k):   
    ...
    Output_scale = Output_scale.astype(np.uint8)
    ...
    ## For each column in scaled Output, reshape into original image size and save in correct directory
    for j in range(Output_scale.shape[1]):
